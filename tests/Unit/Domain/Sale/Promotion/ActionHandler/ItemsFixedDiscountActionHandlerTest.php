...
/**
 * Class ItemsFixedDiscountActionHandlerTest
 * @package Karolak\EcoEngine\Test\Unit\Domain\Sale\Promotion\ActionHandler
 */
class ItemsFixedDiscountActionHandlerTest extends TestCase
{
    /** @var ItemsFixedDiscountActionHandler  */
    private $obj;
    ...
    {
        parent::setUp();
        $this->obj = new ItemsFixedDiscountActionHandler();
    }
    ...
    public function Should_CorrectDiscountOrderItems()
    {
        ...
        $promotion = new Promotion('TEST', 'coupon');
        $action = new ItemsFixedDiscountAction(5000);
     ...
     * @throws ItemNotFoundException
     */
    public function Should_CorrectDiscountOrderItems_When_DiscountIsBiggerThanOrder()
    {
        // Arrange
        $product1 = new Product('1', 2000);
        $product2 = new Product('2', 4000);
        ...
        $promotion = new Promotion('TEST', 'coupon');
        $action = new ItemsFixedDiscountAction(8000);
        ...
        // Assert
        $this->assertEquals(0, $order->getTotalProductsPrice());
        $this->assertEquals(0, $items[0]->getPrice());
        $this->assertEquals(0, $items[1]->getPrice());
    }
}