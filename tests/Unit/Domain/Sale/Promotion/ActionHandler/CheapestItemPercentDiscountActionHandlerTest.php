...
/**
 * Class CheapestItemPercentDiscountActionHandlerTest
 * @package Karolak\EcoEngine\Test\Unit\Domain\Sale\Promotion\ActionHandler
 */
class CheapestItemPercentDiscountActionHandlerTest extends TestCase
{
    /** @var CheapestItemPercentDiscountActionHandler  */
    private $obj;
    ...
    {
        parent::setUp();
        $this->obj = new CheapestItemPercentDiscountActionHandler();
    }
    ...
    public function Should_CorrectDiscountOrderItems_When_ActionOnEveryGroupOfTwoItems()
    {
        ...
        $promotion = new Promotion('TEST', 'coupon');
        $action = new CheapestItemPercentDiscountAction(100.00, 2);
    ...
    public function Should_CorrectDiscountOrderItems_When_ActionOnEveryGroupOfOneItem()
    {
        ...
        $promotion = new Promotion('TEST', 'coupon');
        $action = new CheapestItemPercentDiscountAction(100.00, 1);
